...
class NewMarket extends React.Component {
  ...
  handleAddMarket = async user => {
    ...
    try{
      ...
      const {data} = await API.graphql(graphqlOperation(createMarket, { input }))
      console.log(data)
      console.info(`Created market: id ${data.createMarket.id}`)
  ...
  render() {
    ...
    const { addMarketDialog, name, selectedTags } = this.state;
